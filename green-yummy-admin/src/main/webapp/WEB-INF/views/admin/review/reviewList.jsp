    ...
    <div class="content">
        <div class="content-header">
            ...
            <div class="search-box">
                <form action="/admin/searchReview" method="post">
        ...
        <table class="table">
	        <tbody>
	            <tr>
	                <th>
					<form action="/admin/reviewList" method="get" id="radioBox1">
					<label>
        ...
        <c:choose>
        	<c:when test='${status == -1}'>
		        ...
		        <button style="margin-left:30px;" onclick = 'location="/admin/reviewList?page=${page+1}"' class="btn">&gt;&gt;</button>
	        </c:when>
	        <c:when test='${status == 0}'>
		        <button onclick = 'location="/admin/reviewList?page=${page-1}"' class="btn">&lt;&lt;</button>
		        <button onclick = 'location="/admin/reviewList?page=${page+1}"' class="btn" style="margin-left:30px;">&gt;&gt;</button>
	        </c:when>
	        <c:when test='${status == 1}'>
		        <button onclick = 'location="/admin/reviewList?page=${page-1}"' class="btn">&lt;&lt;</button>
