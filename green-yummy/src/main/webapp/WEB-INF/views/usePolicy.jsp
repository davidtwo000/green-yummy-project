...
제 3 조 (약관의 게시와 개정)
1. 본 약관은 "회원"이 서비스 가입 및 이용시 열람 할 수 있으며, "회사"는 본 약관의 내용을 "회원"이 쉽게 열람할 수 있도록 캐치테이블(catchtable) 서비스 홈페이지(이하 "홈페이지") 또는 연결화면을 통하여 게시합니다.
...
제 5 조 (회원에 대한 통지)
1. "회사"가 "회원"에 대한 통지를 하는 경우 이 약관에 별도 규정이 없는 한 서면(전자문서 또는 전자우편을 포함)에 의하여 "회원"이 "회사"에 제공한 전자우편주소, 전화번호, "캐치테이블"의 알림 기능 기타 전자적 수단 등으로 할 수 있습니다.
2. "회사"는 "회원" 전체에 대하여 통지를 하는 경우 "캐치테이블" 초기화면 또는 게시판에 게시하는 방식으로 공지함으로써 전항의 통지에 갈음할 수 있습니다. 다만, "회원"의 "서비스" 이용에 중대하게 불리한 영향을 주는 사항에 대해서는 전항의 통지를 병행합니다.
