...
('카페모아', '카페', '청담동', '차분하고 아늑한 카페를 운영하고 싶습니다.', '01078901234', DATE(NOW()), 'PENDING', FLOOR(RAND() * 16)+1),
('한식고수', '한식', '삼성동', '전통 한식의 맛을 널리 알리고 싶습니다.', '01089012345', DATE(NOW()), 'PENDING', FLOOR(RAND() * 16)+1),
('일식공방', '일식', '신사동', '정통 일식을 제공하는 작은 공방을 운영하고 싶습니다.', '01090123456', DATE(NOW()), 'PENDING', FLOOR(RAND() * 16)+1),
('분식하우스', '분식', '논현동', '분식의 맛을 정성껏 선보이고 싶습니다.', '01091234567', DATE(NOW()), 'PENDING', FLOOR(RAND() * 16)+1),
('패스트푸드천국', '패스트푸드', '대치동', '빠르고 맛있는 음식을 제공하고 싶습니다.', '01092345678', DATE(NOW()), 'PENDING', FLOOR(RAND() * 16)+1),
('가족카페', '카페', '역삼동', '가족이 함께 즐길 수 있는 카페를 열고 싶습니다.', '01093456789', DATE(NOW()), 'PENDING', FLOOR(RAND() * 16)+1),
('일식정', '일식', '삼성동', '고품질 일식을 선보이고 싶습니다.', '01094567890', DATE(NOW()), 'PENDING', FLOOR(RAND() * 16)+1),
('한식마당', '한식', '신사동', '정성껏 준비한 한식을 제공하고 싶습니다.', '01095678901', DATE(NOW()), 'PENDING', FLOOR(RAND() * 16)+1),
('분식의 달인', '분식', '청담동', '달인의 손길로 만드는 분식을 선보이고 싶습니다.', '01096789012', DATE(NOW()), 'PENDING', FLOOR(RAND() * 16)+1);
